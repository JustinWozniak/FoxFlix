...
class TvShow extends Component {
  ...
  componentDidMount() {
    tvShowKey = this.props.value
    const API_URL = "https://api.themoviedb.org/3/tv/" + tvShowKey + "?api_key=" + process.env.REACT_APP_API_KEY + "&language=en-US&append_to_response=credits"
  ...
  render() {
    tvShowKey = this.state.movieNumber
    return (
      <div>
